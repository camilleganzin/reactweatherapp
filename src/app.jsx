...
var query = ''; // Expects ?city=London,Paris,Berlin,Madrid
var cities = []; // Transform query string into an array
var citiesWeather = []; // API CACHE
var currentCity = 0; // Current city displayed index
...
// Assign the React component to a DOM 
